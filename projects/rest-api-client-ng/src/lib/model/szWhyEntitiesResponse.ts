...
import { SzWhyEntitiesResponseData } from './szWhyEntitiesResponseData';

/**
 * The response describing the result of \"why entities\" operation.
 */
export interface SzWhyEntitiesResponse extends SzResponseWithRawData { 
    data?: SzWhyEntitiesResponseData;
}